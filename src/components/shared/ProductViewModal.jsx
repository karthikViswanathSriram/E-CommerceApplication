...
function ProductViewModal({open,setOpen,product,isAvailable}) {
  ...
  const {
    productId,productName,image,description,quantity,
          ...
          <div className="flex min-h-full items-center justify-center p-4">
            <DialogPanel
              ...
              className="relative transform overflow-hidden rounded-lg bg-white
                        shadow-xl transition-all md:max-w-[620px] md:min-w-[620px] w-full">
                {image && (
            ...
            <div className='px-6 py-4 flex justify-end gap-4'>
                <button 
                    ...
                    hover:text-slate-900 border-2 border-slate-600 hover:border-slate-900 rounded-md"
                    >Close</button>
            </div>
